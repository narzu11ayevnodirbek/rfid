...
class ThemeTextStyles extends ThemeExtension<ThemeTextStyles> {
  const ThemeTextStyles({
    ...
    required this.bodyLargeBoldTitle,
    ...
    required this.primaryFontS32Weight700,
  ...
  final TextStyle bodyLargeBoldTitle;
  ...
  final TextStyle primaryFontS32Weight700;
  ...
  static ThemeTextStyles light = ThemeTextStyles(
    ...
    bodyLargeBoldTitle: const TextStyle(
      color: Colors.black,
      fontSize: 34,
    ...
    primaryFontS32Weight700: TextStyle(
      color: lightColorScheme.primary,
      fontSize: 32,
      fontWeight: FontWeight.w700,
    ),
    fontSize18Weight500: const TextStyle(
      color: Colors.black,
      fontSize: 18,
      fontWeight: FontWeight.w500,
    ),
  ...
  ThemeExtension<ThemeTextStyles> copyWith({
    ...
    TextStyle? primaryFontS32Weight700,
    TextStyle? fontSize18Weight500,
  }) =>
      ThemeTextStyles(
        ...
        bodyLargeBoldTitle: bodyLargeBoldTitle ?? this.bodyLargeBoldTitle,

...
import '../controllers/free_transfer_controller.dart';
import '../models/location_model.dart';

/// ТЗ: Свободное перемещение — выбор «куда», сканирование объектов, кнопка «Переместить».
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                FilledButton.icon(
                  onPressed: c.isSending.value || list.isEmpty
                      ? null
                      : () => c.submit(),
